    ...
    <style>
       ...
       ============================================================ */
        ...
        .feature-item:hover .feature-icon {
            ...
            border-color: var(--clr-accent, #2d2d2d);
...
<body>
    ...
    <section class="hero" id="hero" aria-label="Hero slideshow">
        ...
        <div class="hero-stats">
            <div class="hero-stat">
                <span class="hero-stat-num" data-count="50" data-suffix="+">0</span>
                <span class="hero-stat-lbl">Styles</span>
            </div>
            <div class="hero-stat">
                <span class="hero-stat-num" data-count="2" data-suffix="K">0</span>
                <span class="hero-stat-lbl">Followers</span>
            </div>
            <div class="hero-stat">
                <span class="hero-stat-num" data-count="100" data-suffix="%">0</span>
                <span class="hero-stat-lbl">Authentic</span>
            </div>
        </div>
                        ...
                        <div class="product-card-img">
                            ...
                            <div class="product-card-actions">
                                <button type="button" class="btn btn--primary btn--sm"
                                    onclick="event.preventDefault(); event.stopPropagation(); openQuickView(this.closest('.product-card'))">
                                    Quick Add
                                </button>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="footer-grid">
                ...
                <div>
                    ...
                    <nav class="footer-social footer-social--brand" aria-label="Follow us">
                        <a href="https://www.instagram.com/clothyoutlett/" target="_blank" rel="noopener" aria-label="Instagram">
                ...
                <div>
                    <h4 class="footer-col-title">Payment</h4>
                    <nav class="footer-links">
                        <a href="#">Cash on Delivery</a>
                        <a href="#">Hand-to-Hand Payment</a>
                    </nav>
                </div>
        ...
        <div class="modal-box">
            ...
            <div class="modal-info-col">
                ...
                <div>
                    ...
                    <div class="modal-sizes" id="modalSizes">
                        <?php foreach (['XS', 'S', 'M', 'L', 'XL'] as $sz): ?>
                            <button type="button" class="modal-size-btn" onclick="selectModalSize(this)"><?= $sz ?></button>
                        <?php endforeach; ?>
                    </div>
                </div>
                ...
                <div class="modal-add-cart">
                    <button type="button" class="btn btn--primary btn--full btn--lg" onclick="addToCartFromModal()">Add to Cart</button>
                    <button type="button" class="btn btn--outline  btn--full">Add to Wishlist ♡</button>
                </div>
            </div>
        </div>
    </div>
